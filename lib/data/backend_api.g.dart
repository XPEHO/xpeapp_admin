...
class _BackendApi implements BackendApi {
  ...
  @override
  Future<HttpResponse<dynamic>> subscribeAdminWebNotificationTopic(
    String token,
    Map<String, dynamic> body,
  ) async {
    final _extra = <String, dynamic>{};
    ...
    final _options = _setStreamType<HttpResponse<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'xpeho/v1/notifications/admin-web/subscribe',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<HttpResponse<dynamic>> getQvstCampaignAnalysisById(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<dynamic>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'xpeho/v1/qvst/campaigns/${id}:analysis',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  @override
  Future<HttpResponse<dynamic>> getAllIdeas(int page, String? status) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<dynamic>> getIdeaById(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<dynamic>> addIdea(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<dynamic>> updateIdeaStatus(
    String id,
    Map<String, dynamic> body,
  ) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<dynamic>> getLastConnexionUsers() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
