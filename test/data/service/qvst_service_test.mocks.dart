...
class MockBackendApi extends _i1.Mock implements _i4.BackendApi {
  ...
  @override
  _i5.Future<_i2.HttpResponse<dynamic>> subscribeAdminWebNotificationTopic(
    String? token,
    Map<String, dynamic>? body,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<_i2.HttpResponse<dynamic>> getAllQvst(
    int? page,
  ...
  @override
  _i5.Future<_i2.HttpResponse<dynamic>> getQvstCampaignAnalysisById(
          String? id) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i5.Future<_i2.HttpResponse<dynamic>> getAllIdeas(
    int? page,
    String? status,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<_i2.HttpResponse<dynamic>> getIdeaById(String? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #getIdeaById,
          [id],
  ...
  @override
  _i5.Future<_i2.HttpResponse<dynamic>> addIdea(Map<String, dynamic>? body) =>
      (super.noSuchMethod(
        Invocation.method(
          #addIdea,
          [body],
  ...
  @override
  _i5.Future<_i2.HttpResponse<dynamic>> updateIdeaStatus(
    String? id,
    Map<String, dynamic>? body,
  ) =>
      (super.noSuchMethod(
